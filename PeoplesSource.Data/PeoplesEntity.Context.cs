...
namespace PeoplesSource.Data
{
    ...
    public partial class PeopleSourceEntities : DbContext
    {
        public PeopleSourceEntities()
            : base("name=PeopleSourceEntities")
        {
        }
        ...
        public virtual DbSet<MessageSchedule> MessageSchedules { get; set; }
        public virtual DbSet<ManageScheduleMessage> ManageScheduleMessages { get; set; }
        public virtual DbSet<Manage_OrderMessage> Manage_OrderMessage { get; set; }
        public virtual DbSet<Filteration> Filterations { get; set; }
