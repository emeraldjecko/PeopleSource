...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])Customizeckeditor\.js(?:\?.*|;.*)?$/i, f = {
            ...
            requires: "button", init: function (a) {
                var d, g = function (c, h) {
                    ...
                    if (c.data.space == a.config.toolbarLocation) {
                        c.removeListener(); a.toolbox = new u; var d = CKEDITOR.tools.getNextId(), b = ['<span id="', d, '" class="cke_voice_label">', a.lang.toolbar.toolbars, "</span>", '<span id="' + a.ui.spaceId("toolbox") + '" class="cke_toolbox" role="group" aria-labelledby="', d, '" onmousedown="return false;"><span style="margin-right:20px;" class="pull-left"><button id="btn_Save_Reply" class="btn btn-primary" style="background-color: rgb(26, 179, 148); color: rgb(255, 255, 255); -moz-user-select: none; background-image: none; border: 1px solid transparent; border-radius: 4px; cursor: pointer; display: inline-block; font-size: 14px; font-weight: 400; line-height: 1.42857; margin-bottom: 0px; text-align: center; vertical-align: middle; white-space: nowrap; padding: 3px 12px;">Submit</button></span>'], d = !1 !== a.config.toolbarStartupExpanded, e, j; a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && b.push('<span class="cke_toolbox_main"' +
