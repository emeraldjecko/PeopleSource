...
namespace PeoplesSource.Controllers
{
    public class AccountController : Controller
    {
             ...
             if (ModelState.IsValid)
            {
                ...
                if (MembershipManager.ValidateUser(model.Username, model.Password))
                {
                    ...
                    {                        
                        ...
                        //string fileName1 = ConfigurationHelper.GetTeapplixDownloadFolderPath() + "products.csv";
                        //string fileName2 = ConfigurationHelper.GetTeapplixDownloadFolderPath() + "quantity_report.csv";
                        //string fileName3 = ConfigurationHelper.GetTeapplixDownloadFolderPath() + "order_report.csv";

                        //System.Threading.Tasks.Task[] tasks = new System.Threading.Tasks.Task[3];

                        ////Download and execute ssis package for first file
                        //WebClient _downloadClient1 = new WebClient();
                        //_downloadClient1.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted1);
                        //_downloadClient1.DownloadFileAsync(new Uri(ConfigurationHelper.GetTeapplixProductURL()), fileName1);

                        ////Download and execute ssis package for second file
                        //WebClient _downloadClient2 = new WebClient();
                        //_downloadClient2.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted2);
                        //_downloadClient2.DownloadFileAsync(new Uri(ConfigurationHelper.GetTeapplixQuantityURL()), fileName2);

                        ////Download and execute ssis package for third file
                        //WebClient _downloadClient3 = new WebClient();
                        //_downloadClient3.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted3);
                        //_downloadClient3.DownloadFileAsync(new Uri(ConfigurationHelper.GetTeapplixOrderURL()), fileName3);   
        ...
        public async Task<int> Dosomething()
        {
            ...
            WebClient _downloadClient1 = new WebClient();
            _downloadClient1.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted1);
            await _downloadClient1.DownloadFileTaskAsync(new Uri(ConfigurationHelper.GetTeapplixProductURL()), fileName1);

            //Download and execute ssis package for second file
            WebClient _downloadClient2 = new WebClient();
            _downloadClient2.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted2);
            await _downloadClient2.DownloadFileTaskAsync(new Uri(ConfigurationHelper.GetTeapplixQuantityURL()), fileName2);

            //Download and execute ssis package for third file
            WebClient _downloadClient3 = new WebClient();
            _downloadClient3.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadCompleted3);
            await _downloadClient3.DownloadFileTaskAsync(new Uri(ConfigurationHelper.GetTeapplixOrderURL()), fileName3);
            return 1;
        }
