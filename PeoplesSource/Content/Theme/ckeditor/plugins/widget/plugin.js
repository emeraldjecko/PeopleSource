...
( function() {
	...
	function setupDragHandler( widget ) {
		...
		if ( container )
			...
			container.setAttributes( {
			    'class': 'cke_reset cke_widget_drag_handler_container UpdateWidget',
			...
			img.setAttributes( {
				'class': 'cke_reset cke_widget_drag_handler UpdateWidget',
	...
	function setupMask( widget ) {
		...
		if ( !img ) {
			...
			img.setAttributes( {
				src: CKEDITOR.tools.transparentImageData,
				'class': 'cke_reset cke_widget_mask UpdateWidget'
			} );
